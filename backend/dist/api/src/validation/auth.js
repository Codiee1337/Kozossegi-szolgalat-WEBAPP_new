...
exports.idSchema = exports.loginSchema = exports.registerSchema = void 0;
const joi_1 = __importDefault(require("@hapi/joi"));
const config_1 = require("../config");
const id = joi_1.default.string().required();
...
const password = joi_1.default.string().min(8).max(config_1.BCRYPT_MAXIMUM_BYTES, 'utf8')
    .regex(/^(?=.*?[\p{Lu}])(?=.*?[\p{Ll}])(?=.*?\d).*$/u)
